...
async def start(client:Client, message): 
            ...
            if refData and refData.split("-", 1)[0] == "biisal":
                ...
                if AUTH_CHANNEL and await is_req_subscribed(client, message):
                        buttons = [[
                            ...
                            [
                            InlineKeyboardButton('REPORT MISSING MOVIES HERE', callback_data='earn')
                            ]]
    ...
    afterDelCap = "<b>ʏᴏᴜʀ ғɪʟᴇ ɪs ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ᴠɪᴏʟᴀᴛɪᴏɴs! PLEASE FORWARD FILES SOMEWHERE AND START DOWNLOADIN </b>".format(f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs') 
    replyed = await message.reply(
        delCap,
